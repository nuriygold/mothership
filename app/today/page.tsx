    ...
    ...(item.taskId ? [
      {
        ...
        fn: async () => { onComplete(item.taskId!, item.title); },
      },
      {
        key: 'start',
        icon: Zap,
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-2 scrollbar-hide">
          {actions.map((a) => (
            ...
            >
              ...
              >
                {busy === a.key ? (
                  <div className="w-4 h-4 rounded-full border-2 animate-spin" style={{ borderColor: a.textColor, borderTopColor: 'transparent' }} />
                ) : done === a.key ? (
