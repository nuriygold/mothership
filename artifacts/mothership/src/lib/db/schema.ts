...
export const dispatchCampaigns = pgTable('DispatchCampaign', {
  ...
  workerRunOwner: text('workerRunOwner'),
  workerRunLeaseUntil: timestamp('workerRunLeaseUntil', { withTimezone: true }),
  artifactsWrittenAt: timestamp('artifactsWrittenAt', { withTimezone: true }),
  completionNotifiedAt: timestamp('completionNotifiedAt', { withTimezone: true }),
  callbackDeliveredAt: timestamp('callbackDeliveredAt', { withTimezone: true }),
